...
// TargetRefApplyConfiguration constructs a declarative configuration of the TargetRef type for use with
// apply.
...
func (b *TargetRefApplyConfiguration) WithName(value string) *TargetRefApplyConfiguration {
	b.Name = &value
	return b
}
