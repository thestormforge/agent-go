...
// apply.
func Reliability() *ReliabilityApplyConfiguration {
	return &ReliabilityApplyConfiguration{}
}

// WithOom sets the Oom field in the declarative configuration to the given value
