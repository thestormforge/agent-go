...
// WorkloadSettingsApplyConfiguration constructs a declarative configuration of the WorkloadSettings type for use with
// apply.
func WorkloadSettings() *WorkloadSettingsApplyConfiguration {
	return &WorkloadSettingsApplyConfiguration{}
}
...
func (b *WorkloadSettingsApplyConfiguration) WithGoal(value optimizev1.Goal) *WorkloadSettingsApplyConfiguration {
	b.Goal = &value
	return b
}
