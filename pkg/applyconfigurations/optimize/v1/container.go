...
type ContainerApplyConfiguration struct {
	...
	Memory *ResourceSettingsApplyConfiguration `json:"memory,omitempty"`
}
...
func (b *ContainerApplyConfiguration) WithCPU(value *ResourceSettingsApplyConfiguration) *ContainerApplyConfiguration {
	b.CPU = value
	return b
}
...
func (b *ContainerApplyConfiguration) WithMemory(value *ResourceSettingsApplyConfiguration) *ContainerApplyConfiguration {
	b.Memory = value
	return b
}
